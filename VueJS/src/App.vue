<template>
  <div id="app"> 
    ...
    <div v-else>
        ...
        <section>
          <button @click="addNewQuiz">Créer un nouveau quizz</button>
        </section>
    </div>
  </div>
</template>
...
<script>
import AllQuizzes from './components/Accueil.vue';
import QuizDetail from './components/QuizzDetails.vue';
import NewQuizForm from './components/AjoutQuizzForm.vue';
